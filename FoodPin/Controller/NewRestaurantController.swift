...
class NewRestaurantController: UITableViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate
 {
    ...
    @IBOutlet var webTextField: RoundedTextField! {
        didSet {
            webTextField.tag = 2
    ...
    @IBAction func saveButtonTapped(sender: AnyObject) {
        ...
        if nameTextField.text == "" || typeTextField.text == "" || addressTextField.text == "" || phoneTextField.text == "" || webTextField.text == "" || descriptionTextView.text == "" {
        ...
        let newValue = Restaurant(name: nameTextField.text!, type: typeTextField.text!, location: addressTextField.text!, phone: phoneTextField.text!, summary: descriptionTextView.text!, image: selectedImageName,web: webTextField.text!, isVisited: false)
